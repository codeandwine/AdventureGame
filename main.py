...
def intro(weapon, enemy):
    ...
    print_sleep('Rumor has it that an evil sprit is still roaming the '
                'mountains.', 1.5)
...
def drink_water(weapon, enemy):
    if weapon == "Magical Sword":
        ...
        print_sleep("You rid yourself of your hatchet and take the sword.", 2)
...
def run_away(weapon, enemy):
    print_sleep("You run back to where you started in the Jungle of "
                "Belize!", 2)
